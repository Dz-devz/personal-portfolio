export default function Footer() {
  return (
    ...
    // </footer>
    <>
      <footer className="fixed right-0 left-0 top-1/2 p-2 px-3 text-[8px] tracking-widest rotate-180">
      ...
      <footer className="fixed right-0 left-0 top-1/2 p-2 px-3 text-[8px] tracking-widest">
        <span className="rotate-90 inline-block font-chivo">
