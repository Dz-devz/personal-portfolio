              ...
              <Card className="bg-[#ECE8E1]">
                <CardHeader className="font-chivo text-center">
                  ...
                  <CardDescription className="text-md">
                    I’m not just a developer, I’m also a music producer and
                    artist, known by the name DzPen. Music has always been a big
                    part of my journey, and I’ve created several songs that
                    reflect my creativity. Here are some of my works.
                  </CardDescription>
                </CardHeader>
              </Card>
            </div>
